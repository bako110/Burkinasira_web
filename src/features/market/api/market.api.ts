...
import type { ArtisanSummary, ProductDetail, ProductFilters, ProductSummary } from '../types';
...
export async function fetchArtisans(params: { region?: string; verified_only?: boolean } = {}): Promise<
  ArtisanSummary[]
> {
