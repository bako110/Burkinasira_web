...
import type { CultureContentSummary, CultureContentType } from '../types';
...
export function CulturePage() {
  ...
  const [accumulated, setAccumulated] = useState<CultureContentSummary[]>([]);
  ...
  function applyType(value: CultureContentType | undefined) {
    setSearchParams((prev) => {
      const next = new URLSearchParams(prev);
  ...
  return (
    <div className={styles.page}>
      <ListingHero
        ...
        searchPlaceholder={t('culture.searchPlaceholder')}
