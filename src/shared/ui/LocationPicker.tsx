...
export function LocationPicker({
  ...
  onChange,
  mapLabel = 'Carte',
  linkLabel = 'Lien Google Maps',
  linkPlaceholder = 'https://maps.google.com/?q=12.35,-1.52',
  useLinkLabel = 'Utiliser',
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.coordRow}>
        <div className={styles.coordField}>
          <label className={styles.coordLabel}>{latitudeLabel}</label>
          <input
            type="number"
            step="any"
        ...
        <div className={styles.coordField}>
          <label className={styles.coordLabel}>{longitudeLabel}</label>
          <input
            type="number"
            step="any"
            className={styles.coordInput}
